...
class _SupportScreenState extends State<SupportScreen> {
  ...
  final List<Map<String, String>> _faqs = [
    {
      'q': 'كيف يتم التحقق من موثوقية الممرضين في سَنَد؟',
    ...
    },
    {
      ...
      'a': 'تطبيق سَنَد مخصص لجمهورية مصر العربية ويوفر تغطية في كافة محافظات مصر وعلى رأسها القاهرة، الجيزة، الإسكندرية، ومحافظات الدلتا والصعيد.',
    },
    {
    ...
    },
    {
      ...
      'a': 'تتيح منصة سَنَد الدفع النقدي المباشر بعد انتهاء الخدمة، بالإضافة للمحافظ الإلكترونية (فودافون كاش وغيرها) والبطاقات البنكية.',
    },
    {
      'q': 'ماذا أفعل في الحالات الطارئة؟',
      'a': 'خدمات سَنَد مخصصة للرعاية المنزلية والتمريضية غير الطارئة. في الحالات الحرجة أو الطوارئ الطبية العاجلة، يُرجى الاتصال فوراً بهيئة الإسعاف المصرية على الرقم 123.',
    },
  ];
